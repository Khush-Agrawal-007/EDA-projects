...
â”œâ”€â”€ README.md
â””â”€â”€ images/ (optional exported plots)
```
...
## Key Findings (summary â€” numeric values to be filled after running notebooks)
...
- Weak correlation between price and rating (Pearson r â‰ˆ 0.XX).
...
- Cleaned dataset (CSV) â€” generated by the notebook
